...
def run_scientist_gpt(data_file_descriptions: DataFileDescriptions,
    ...
    try:
        ...
        _save_all_files_to_output_folder(output_directory, data_file_descriptions.data_folder,
                                         data_file_descriptions.get_data_filenames())
...
def _save_all_files_to_output_folder(output_directory, absolute_data_path, data_filenames):
    """
    ...
    for file in glob.glob(str(absolute_data_path / '*.txt')):
        if os.path.basename(file) not in data_filenames:
            shutil.move(file, output_directory)
