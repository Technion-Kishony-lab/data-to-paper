...
@dataclass
class ProduceDemoPaperPDF(BaseLatexToPDFWithAppendix, BaseLatexToPDFWithCode):
    ...
    def _create_appendix(self):
        ...
        s += '\n\n' + self.products.code_and_output.to_latex(latex_formatter=self.code_latex_formatter)
        return s
